...
public class ApiControllerTest {
	...
	@Test
	public void testSendApiRequest() throws Exception {
		...
		try {
			MvcResult result = mockMvc.perform(get("/sendApiRequest").param("apiUrl", apiUrl))
	...
	public void testControllerStructure() throws Exception {
		...
		boolean result = JavaParserUtils.checkControllerStructure(filePath, // Pass the class file path
				...
				"sendApiRequest", // Check if the method name is correct
